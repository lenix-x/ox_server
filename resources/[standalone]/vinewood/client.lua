...
Citizen.CreateThread(function()
    LoadFramework()
    TriggerServerEvent('vinewood:loadText')
end)

RegisterNetEvent('vinewood:openNui')
AddEventHandler('vinewood:openNui', function(text, color)
    nuiOpen = true
...
RegisterNUICallback('saveText', function(data)
    TriggerServerEvent('vinewood:saveText', data)
end)
...
RegisterNetEvent('vinewood:saveText')
