...
LoadFramework = function()
    ...
    print('[Vinewood] Framework found: ' .. FrameworkFound)
end
...
RegisterCommand(Config.Command, function(source, args, rawCommand)
    ...
    TriggerClientEvent('vinewood:openNui', source, GetFileData()[1], GetFileData()[2])
end)

RegisterServerEvent('vinewood:saveText')
AddEventHandler('vinewood:saveText', function(data)
    ...
    TriggerClientEvent('vinewood:saveText', -1, file)
end)

RegisterServerEvent('vinewood:loadText')
AddEventHandler('vinewood:loadText', function()
    TriggerClientEvent('vinewood:saveText', source, GetFileData())
end)
