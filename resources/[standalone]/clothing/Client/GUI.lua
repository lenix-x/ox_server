...
local function DrawButton(b)
	...
	if b.Shadow then
		DrawSprite("clothing", "circle", b.x, b.y, b.Size.Circle.x/0.80, b.Size.Circle.y/0.80, Rot, b.Colour.r, b.Colour.g, b.Colour.b, b.Alpha)
	end
	DrawSprite("clothing", b.Sprite, b.x, b.y, b.Size.Sprite.x/0.68, b.Size.Sprite.y/0.68, b.Rotation, 255, 255, 255, b.Alpha)
...
local function DrawGUI()
	...
	for k,v in pairs(Buttons) do
		...
		DrawSprite("wheel", k.."", x, y, 0.4285, 0.7714, 0.0, Colour.r, Colour.g, Colour.b, Colour.a)
...
local TextureDicts = {"clothing", "wheel"}
Citizen.CreateThread(function()
