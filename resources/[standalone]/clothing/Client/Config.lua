Config = {
	Language = "en",					-- Anda dapat mengubah bahasa di sini. Saya menerjemahkan beberapa dengan alat online jadi mungkin tidak 100% akurat. Biarkan aku tahu!
	ExtrasEnabled = true,				-- Ini mematikan perintah ekstra (Kaos, Celana) jika Anda tidak ingin pemain Anda menanggalkan pakaian mereka karena alasan apa pun.
	Debug = false,						-- Memungkinkan pencatatan dan tampilan layar dari apa yang dikenakan karakter Anda.
	GUI = {
		Position = {x = 0.75, y = 0.5},	-- 0,5 di tengah!
		AllowInCars = false,			-- Izinkan GUI di mobil?
		AllowWhenRagdolled = false,			-- Izinkan GUI saat pingsan?
		Enabled = true, 				-- Anda dapat mematikan gui di sini, perintah dasar akan tetap berfungsi.
		Key = GetKey("Y"), 				-- Ubah kunci GUI di sini.
		Sound = true,					-- Anda dapat menonaktifkan suara di GUI di sini.
