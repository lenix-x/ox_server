...
RegisterNetEvent('clothing:EquipLast')
AddEventHandler('clothing:EquipLast', function()
...
RegisterNetEvent('clothing:ResetClothing')
AddEventHandler('clothing:ResetClothing', function()
	LastEquipped = {}
end)
...
RegisterNetEvent('clothing:ToggleMenu')
AddEventHandler('clothing:ToggleMenu', function()
...
RegisterNetEvent('clothing:Menu')
AddEventHandler('clothing:Menu', function(status)
	MenuOpened = status
